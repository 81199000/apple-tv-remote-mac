...
class RemoteDetector {
    ...
    private let knownProductIDs: [Int] = [
        // 0x0266 is this Mac's first-generation Siri Remote. Do not include
        // 0x0267: on this machine that product ID is the Magic Keyboard.
        0x0221, 0x0255, 0x0266, 0x0269,
